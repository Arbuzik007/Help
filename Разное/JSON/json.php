...
$filename = 'D:/zlata/JSON/data.json';
...
// …то создаём его сами
    $file = fopen("D:/zlata/JSON/data.json", "a+");
}
...
file_put_contents('D:/zlata/JSON/data.json', json_encode($taskList));
// …и сразу считываем их обратно
$file = file_get_contents('D:/zlata/JSON/data.json'); // Открыть файл data.json
